...
extern size_t __attribute__((section(".data"))) aes_aesni_gctr_linear(void *icb, void* x, void *y, unsigned int num_blocks);
...
extern size_t __attribute__((section(".data"))) aes_vaes_gctr_linear(void *icb, void* x, void *y, unsigned int num_blocks);
...
static size_t __attribute__((optimize("O0"), target("avx2"))) call_vaes_implementation(void *icb, const void* x, void *y, unsigned int num_blocks, const void* aes_fun) {
    size_t ret;
...
static inline size_t call_aes_implementation(void *icb, const void* x, void *y, unsigned int num_blocks, const void* aes_fun, unsigned char has_vaes) {
...
int aes_128_ctr_init(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen, const OSSL_PARAM __attribute__((unused)) params[]);
int aes_128_ctr_stream_update(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl);
int aes_128_ctr_stream_final(void *vctx, unsigned char *out, size_t *outl, size_t outsize);
int aes_128_ctr_cipher(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl);
...
// AES-128-GCM
int aes_128_gcm_einit(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[]);
int aes_128_gcm_dinit(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[]);
...
int aes_128_gcm_stream_update(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl);
int aes_128_gcm_stream_final(void *vctx, unsigned char *out, size_t *outl, size_t outsize);
int aes_128_gcm_cipher(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl);
